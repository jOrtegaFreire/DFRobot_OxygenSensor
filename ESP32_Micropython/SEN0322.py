'''!
  @file SEN0322.py
  @brief Micropython library for Gravity: Electrochemical Oxygen Sensor (SEN0322)
  @author [jOrtegaFreire](j.ortegafreire@gmail.com)
  @version V1.0
  @date 2022-08-13
  @url https://github.com/jOrtegaFreire/SEN0322_OxygenSensor
'''
